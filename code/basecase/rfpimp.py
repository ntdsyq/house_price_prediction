# source: https://github.com/parrt/random-forest-importances/blob/master/src/rfpimp.py#L263
# companion article: https://explained.ai/rf-importance/index.html
...
def permutation_importances_raw(rf, X_train, y_train, metric, n_samples=5000):
    ...
    # modified to remove deep = False. X_train = X_sample.copy(deep=False) # shallow copy
